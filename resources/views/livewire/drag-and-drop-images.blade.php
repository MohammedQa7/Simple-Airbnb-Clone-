    ...
    <section class=" mt-5">
        <div class="container d-flex justify-content-center align-items-center">
                <div class="image-uploader-holder">
                    <h1>Add some photos of your cabin</h1>
                    <p>You'll need 5 photos to get started. You can add more or make changes later.</p>
                    <label x-on:dragover.prevent="dragover" x-on:dragleave.prevent="dragleave" x-on:drop="drop($event)" class="custum-file-upload mt-4" for="file">
