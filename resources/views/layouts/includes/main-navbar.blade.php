<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container d-flex justify-content-between">
          ...
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
              ...
              <div class="collapse navbar-collapse  ms-5" id="nonCollapseNav">
                  <div id="nonCollapseFilter" class="searchable-space ">
                      <div class="filter-by  d-flex justify-content-between align-items-center" >
                          <a class="filter-by-week pe-3 ps-2"  style="position: relative;">
                              Any week
                          </a>
                              <a class="filter-by-guest pe-2 ps-3 dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                  Add guest
                              </a>
                          <div class="dropdown-menu filter-by-guest-dropdown  mb-2">
                              <div class="guest-picker">
                                  <div class="Adult-type d-flex justify-content-between">
                                      ...
                                      <div class="incrementers d-flex justify-content-center align-items-center">
                                          <button>
                                          ...
                                          <button>
                                              <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" style="display: block; height: 12px; width: 12px; fill: var(--Grey);" aria-hidden="true" role="presentation" focusable="false"><path d="m6.75.75v4.5h4.5v1.5h-4.5v4.5h-1.5v-4.5h-4.5v-1.5h4.5v-4.5z"></path></svg>                                                            </button>
                                      </div>
                                  </div>
                                  ...
                                  <div class="Children-type mb-4 mt-4 d-flex justify-content-between">
                                      ...
                                      <div class="incrementers d-flex justify-content-center align-items-center">
                                          ...
                                          <p class="increment-value me-3 ms-3">0</p>
                                          <button>
                                              <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" style="display: block; height: 12px; width: 12px; fill: var(--Grey);" aria-hidden="true" role="presentation" focusable="false"><path d="m6.75.75v4.5h4.5v1.5h-4.5v4.5h-1.5v-4.5h-4.5v-1.5h4.5v-4.5z"></path></svg>                                                            </button>
                                      </div>
                                  </div>
                          ...
                          <button id="searchBtn" class="d-flex justify-content-center align-items-center  ms-2">
                              <img width="12px" height="12px" src="{{asset('Assets/images/Icons/search-icon.svg')}}" alt="">
                          </button>
                      </div>
                  </div>
              </div>

              <div class="user-nav-section d-flex justify-content-center align-items-center">
                  <div class="airbnb-setup" >
                      <a href="{{URL('setup-your-place')}}">Airbnb your home</a>
                  </div>

                  <div class="language-selector ">
                      <!-- will open a modal -->
                        <a href="" class=" d-flex justify-content-center align-items-center">
                          <img src="{{asset('Assets/images/Icons/Language.svg')}}" alt="">
                        </a>
                  </div>
                  <div class="profile-navigator">
                      <!-- we will get it from jetstream in laravel -->
                  </div>
              </div>
    </div>
  </nav> 