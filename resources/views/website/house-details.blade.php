...
<body>
    ...
    <div id="show-on-scroll-nav" class="show-on-scroll-nav">
        <div class="container">
            <div class="section-hooks d-flex ">
                <a href="#house-image" class="hooks position-relative">
                    <div>
                        Photos
                    </div>
                </a>
                <a href="#amenities-section" class="hooks position-relative">
                    <div>
                        Amenities
                    </div>
                </a>
                <a href="#review-section" class="hooks position-relative">
                    <div>
                        Reviews
                    </div>
                </a>
    ...
    {{-- Place details --}}
    <div id="house-image"  class="container house-details">
        @livewire('place_details' , ['single_place' => $single_place] , key($single_place->id.now()))    
    </div>
    ...
    {{-- <div>
        ...
        <div id="house-image"  class="container house-details">
            ...
            <div class="house-details-header d-flex justify-content-between align-items-center">
                ...
                <a x-data x-on:click="$dispatch('open-modal' , {name: 'images'}>
            ...
            <div class="hosue-images mt-3">
                <div class="row g-2">
                    ...
                    @endif
                    @endforeach
                            <a href="" class="show-more-images-link position-absolute">
            ...
            <div  class="house-details-information mt-4">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        @livewire('reservation_card' , ['single_place' => $single_place] , key($single_place->id.now()))
                </div>
