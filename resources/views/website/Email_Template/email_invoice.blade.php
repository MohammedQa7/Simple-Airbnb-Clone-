...
------------------------------------- */
    ...
    .reservation-details-table tbody{
        text-align: left;
    }
...
------------------------------------- */
    ...
    .btn a {
      ...
      border-radius: 4px;
      box-sizing: border-box;
      background: linear-gradient(90deg, rgba(230,31,77,255) 50%, rgba(215,6,102,255) 100%);
      cursor: pointer;
                  ...
                  <table class="reservation-details-table"> 
                      <tbody>
                        <tr>
                          ...
                          <tr>
                            <td>{{$place['single_place']['title']}}</td>
                            <td>{{Carbon\Carbon::parse($place['start_date'])->format('Y/m/d')}}</td>
                            <td>{{Carbon\Carbon::parse($place['end_date'])->format('Y/m/d')}}</td>
                            <td>{{$place['total_guests']}}</td>
                            <td>${{$total_price}}</td>
                          </tr>
                      </tbody>
                  </table>
                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td>  <a href="http://127.0.0.1:8000/homepage" target="_blank">Explore more places</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">{{config('app.name')}} Inc, {{\Carbon\Carbon::now()->format('Y')}}</span>
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="http://127.0.0.1:8000/homepage">{{config('app.name')}}</a>
                  </td>
                </tr>
              </table>
            </div>
